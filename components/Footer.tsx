        ...
        <footer className="bg-gray-100">
            <div className="mx-auto max-w-5xl px-4 pt-16 sm:px-6 lg:px-8">
                ...
                <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                    ...
                    <li>
                        <Link className="text-gray-700 transition hover:text-gray-700/75" href={'/destinations'}> Destinations </Link>
                    </li>

                    <li>
                        <Link className="text-gray-700 transition hover:text-gray-700/75" href={'/experience'}> Experience </Link>
                    </li>
